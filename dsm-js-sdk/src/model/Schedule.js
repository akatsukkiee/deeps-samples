...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Deepsecurity.Schedule = factory(root.Deepsecurity.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('hoursOfWeek')) {
        obj['hoursOfWeek'] = ApiClient.convertToType(data['hoursOfWeek'], ['Boolean']);
      }
   ...
   * @member {Array.<Boolean>} hoursOfWeek
   */
  exports.prototype['hoursOfWeek'] = undefined;
  /**
